    ...
    def get_contact_list(self):  # загруж из БД инфу о контактах
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), name=firstname, lastname=lastname, address=address, all_phones_from_home_page=[home, mobile, work, phone2], all_emails_from_home_page=[email, email2, email3]))
        finally:
            cursor.close()
        return list
